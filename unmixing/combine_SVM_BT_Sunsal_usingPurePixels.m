function combine_SVM_BT_Sunsal_usingPurePixels()
...
for a = 1:50 % to obtain an average accuracy
    ...
    alphas = sumAbundancesPerClass(trainNeighData,trainNeighMatrix,alphas);
    
    [maxAcc,maxW] = simpleWeightedCombination(prob_valuesE,alphas,testLabels);
