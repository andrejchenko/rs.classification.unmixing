function [trainData,trainLabels, testData, testLabels,endMembers,trainMatrix,testMatrix] = select5TrainingPixelsPerClass(indian_pines,indian_pines_gt,numBands)
