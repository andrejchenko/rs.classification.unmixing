...
accUnmixing = 0;
    ...
    [trainNeighData,trainNeighLabels,trainNeighMatrix] = selectPurePixels(trainNeighMatrix,trainNeighLabels);
...
%     str = ['Average susnal unmixing accuracy using pure pixels for endmembers: ', num2str(EVAL_APHA(1)*100)];
%     str
