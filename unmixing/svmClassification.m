%%Train the libsvm classifier and classify the test pixels

function [predict_label, accuracy, prob_values] = svmClassification(trainData,trainLabels, testData, testLabels)
